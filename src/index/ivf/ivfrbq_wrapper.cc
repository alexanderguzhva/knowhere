...
IVFRaBitQIteratorWorkspace::IVFRaBitQIteratorWorkspace(
    const IndexIVFRaBitQWrapper* wrapper_in, const float* query_data_in,
    ...
    inner = std::make_unique<faiss::cppcontrib::knowhere::IVFBaseIteratorWorkspace>(
        index_rbq, transformed_query.get(), params);
